> **⚠️ OBSOLETE — Design review from 2026-05-21.**
>
> The extension architecture described below has been implemented. See `docs/agents/architecture.md` for the current architecture and `docs/agents/tools-and-skills.md` for tool details.
