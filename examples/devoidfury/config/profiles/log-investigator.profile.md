...
# Your job: session log investigator

Read JSONL session logs, identify patterns that indicate pain points in tool usage, and produce a structured report with actionable improvement proposals.
