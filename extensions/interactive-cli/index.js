...
export function create(core) {
  ...
  async function runInteractiveSession(cli, core) {
    ...
    // Create output sink
    const { CliOutputSink } = await import("../../src/ui/cli.js");
    ...
    // Build LLM client
    const { LlmClient } = await import("../../src/llm_client/client.js");
    const { MarkerMangler } = await import("../../src/marker_mangler.js");
