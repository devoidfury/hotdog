...
import { LspHoverTool } from "../../src/extensions/lsp/tools/lsp-hover.js";
  ...
  describe("execute", () => {
    ...
    it("returns error for non-existent file", async () => {
      const result = await tool.execute(
        {
          file: "/nonexistent/path/that/does/not/exist.js",
          line: 0,
          character: 0,
        },
        {},
    ...
    it("returns error when no LSP server configured", async () => {
      const result = await tool.execute(
        {
          file: path.join(PROJECT_ROOT, "src/extensions/core-tools/read.js"),
          line: 1,
          character: 0,
        },
        new ToolContext({
          cwdBoundary: PROJECT_ROOT,
