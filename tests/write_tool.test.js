...
describe('WriteTool.execute — insert_before', () => {
  ...
  it('errors on missing start_at', async () => {
    ...
    expect(result).toContain('insert_before requires path, start_at, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
...
describe('WriteTool.execute — replace_all', () => {
  ...
  it('errors on missing search', async () => {
    ...
    expect(result).toContain('replace_all requires path, search, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
});
...
describe('WriteTool.execute — regex_replace', () => {
  ...
  it('errors on missing search_re', async () => {
    ...
    expect(result).toContain('regex_replace requires path, search_re, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
...
describe('WriteTool.execute — replace_range', () => {
  ...
  it('errors when start_at > end_at', async () => {
    ...
    expect(result).toContain('start_at must be <= end_at');
    fs.rmSync(dir, { recursive: true, force: true });
  });
  ...
  it('errors on missing start_at', async () => {
    ...
    expect(result).toContain('replace_range requires path, start_at, end_at, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
});
...
describe('WriteTool.execute — replace_range_literal', () => {
  ...
  it('errors on missing search', async () => {
    ...
    expect(result).toContain('replace_range_literal requires path, search, start_at, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
...
describe('WriteTool.execute — replace_range_regex', () => {
  ...
  it('errors on missing search_re', async () => {
    ...
    expect(result).toContain('replace_range_regex requires path, search_re, start_at, and content');
    fs.rmSync(dir, { recursive: true, force: true });
  });
});
